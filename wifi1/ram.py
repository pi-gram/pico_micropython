import gc
import time
from picographics import PicoGraphics, DISPLAY_PICO_DISPLAY, PEN_RGB332, #PEN_RGB565 #PEN_RGB332
...
#display = PicoGraphics(DISPLAY_PICO_DISPLAY, pen_type=PEN_RGB565, rotate=0)
